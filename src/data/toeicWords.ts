...
import { TOEIC_BACK_CARD_JA, padJaList } from './toeicBackCardJa';
...
export const RAW_TOEIC_WORDS: RawToeicWord[] = [
  ...
  },
  {
    ...
    synonyms:["fee","payment","brokerage","appoint"],
    difficulty:"Word stress",
  ...
  },
  {
    ...
    synonyms:["address","include","encompass","protect"],
    difficulty:"Final consonant",
  ...
  },
  {
    ...
    synonyms:["guide","manage","steer","frank"],
    difficulty:"Final consonant",
...
{
    id:101, word:"request", stress:"rih-KWEST",
    pos:["noun","verb"],
  ...
  {
    id:102, word:"provide", stress:"pruh-VYD",
    pos:["verb"],
  ...
  {
    id:103, word:"receive", stress:"rih-SEEV",
    pos:["verb"],
  ...
  {
    id:104, word:"increase", stress:"IN-krees (n) · in-KREES (v)",
    pos:["noun","verb"],
  ...
  {
    id:105, word:"decrease", stress:"DEE-krees (n) · dih-KREES (v)",
    pos:["noun","verb"],
  ...
  {
    id:106, word:"complete", stress:"kum-PLEET",
    pos:["verb","adjective"],
  ...
  {
    id:107, word:"contact", stress:"KON-takt (n) · KON-takt or kun-TAKT (v)",
    pos:["noun","verb"],
  ...
  {
    id:108, word:"attend", stress:"uh-TEND",
    pos:["verb"],
  ...
  {
    id:109, word:"prepare", stress:"prih-PAIR",
    pos:["verb"],
  ...
  {
    id:110, word:"apply", stress:"uh-PLY",
    pos:["verb"],
  ...
  {
    id:111, word:"consider", stress:"kun-SID-ur",
    pos:["verb"],
  ...
  {
    id:112, word:"improve", stress:"im-PROOV",
    pos:["verb"],
  ...
  {
    id:113, word:"offer", stress:"OF-ur",
    pos:["noun","verb"],
  ...
  {
    id:114, word:"ensure", stress:"in-SHOOR",
    pos:["verb"],
  ...
  {
    id:115, word:"manage", stress:"MAN-ij",
    pos:["verb"],
  ...
  {
    id:116, word:"include", stress:"in-KLOOD",
    pos:["verb"],
  ...
  {
    id:117, word:"expect", stress:"ik-SPEKT",
    pos:["verb"],
  ...
  {
    id:118, word:"result", stress:"rih-ZULT",
    pos:["noun","verb"],
  ...
  {
    id:119, word:"annual", stress:"AN-yoo-ul",
    pos:["adjective"],
  ...
  {
    id:120, word:"current", stress:"KUR-unt",
    pos:["adjective","noun"],
  ...
  {
    id:121, word:"recent", stress:"REE-sunt",
    pos:["adjective"],
  ...
  {
    id:122, word:"necessary", stress:"NES-uh-ser-ee",
    pos:["adjective"],
  ...
  {
    id:123, word:"possible", stress:"POS-ih-bul",
    pos:["adjective"],
  ...
  {
    id:124, word:"standard", stress:"STAN-durd",
    pos:["noun","adjective"],
  ...
  {
    id:125, word:"limited", stress:"LIM-ih-tid",
    pos:["adjective"],
  ...
  {
    id:126, word:"special", stress:"SPESH-ul",
    pos:["adjective","noun"],
  ...
  {
    id:127, word:"total", stress:"TOH-tul",
  ...
  {
    id:128, word:"local", stress:"LOH-kul",
    pos:["adjective","noun"],
  ...
  {
    id:130, word:"however", stress:"how-EV-ur",
  ...
  {
    id:131, word:"therefore", stress:"THAIR-for",
    pos:["adverb","conjunction"],
  ...
  {
    id:132, word:"immediately", stress:"ih-MEE-dee-ut-lee",
    pos:["adverb"],
  ...
  {
    id:133, word:"recently", stress:"REE-sunt-lee",
    pos:["adverb"],
  ...
  {
    id:134, word:"currently", stress:"KUR-unt-lee",
    pos:["adverb"],
  ...
  {
    id:135, word:"approximately", stress:"uh-PROK-sih-mut-lee",
    pos:["adverb"],
  ...
  {
    id:136, word:"typically", stress:"TIP-ih-klee",
    pos:["adverb"],
  ...
  {
    id:137, word:"usually", stress:"YOO-zhoo-uh-lee",
    pos:["adverb"],
  ...
  {
    id:138, word:"furthermore", stress:"FUR-thur-mor",
    pos:["adverb"],
  ...
  {
    id:139, word:"additionally", stress:"uh-DISH-un-ul-ee",
    pos:["adverb"],
  ...
  {
    id:140, word:"customer", stress:"KUS-tuh-mur",
    pos:["noun"],
  ...
  {
    id:141, word:"service", stress:"SUR-viss",
    pos:["noun","verb"],
  ...
  },
  {
    ...
    synonyms:["account","document","summary","present"],
    difficulty:"R vs L",
    pronNote:"Initial /r/: rih-PORT. /r/ not /l/. /ɔr/ in '-port'. 2 syllables, stress on 2nd"
  },
  {
    id:143, word:"order", stress:"OR-dur",
    pos:["noun","verb"],
  ...
  {
    id:144, word:"product", stress:"PROD-ukt",
    pos:["noun"],
  ...
  {
    id:145, word:"project", stress:"PROJ-ekt (n) · pruh-JEKT (v)",
    pos:["noun","verb"],
  ...
  {
    id:146, word:"staff", stress:"STAFF",
    pos:["noun","verb"],
  ...
  {
    id:147, word:"client", stress:"KLY-unt",
    pos:["noun"],
  ...
  {
    id:148, word:"payment", stress:"PAY-munt",
    pos:["noun"],
  ...
  {
    id:149, word:"price", stress:"PRYCE",
    pos:["noun","verb"],
  ...
  {
    id:150, word:"account", stress:"uh-KOWNT",
    pos:["noun","verb"],
...
/** Hard cap: only first 3 phrases / synonyms / antonyms are used in the app. */
const MAX_PHRASES_PER_HEADWORD = 3;
const MAX_SYNONYMS_PER_HEADWORD = 3;
const MAX_ANTONYMS_PER_HEADWORD = 3;
...
function rawToToeic(w: RawToeicWord): ToeicWord {
  ...
  const back = TOEIC_BACK_CARD_JA[w.id];
  const backDefs = back?.defs ?? [];
  /** When the back card splits one English sense into multiple JA lines (e.g. two meanings), pad with empty EN; UI hides blank EN and shows JA only. */
  const defRowCount = Math.max(definitions.length, backDefs.length);
  const definitionsAligned =
    definitions.length >= defRowCount
      ? definitions.slice(0, defRowCount)
      : [
          ...definitions,
          ...Array.from({ length: defRowCount - definitions.length }, () => ''),
        ];
  const definitionsJa = padJaList(backDefs, defRowCount);
  const antRow = TOEIC_ANTONYMS[w.id];
  const antEn = (antRow?.en ?? []).slice(0, MAX_ANTONYMS_PER_HEADWORD);
  const antJaSrc = (antRow?.ja ?? []).slice(0, antEn.length);
  const phrasesEn = (w.phrases ?? []).slice(0, MAX_PHRASES_PER_HEADWORD);
  const synonyms = (w.synonyms ?? []).slice(0, MAX_SYNONYMS_PER_HEADWORD);
  return {
    id: w.id,
    word: w.word,
    stressHint: w.stress,
    ...
    partOfSpeech: w.pos,
    meaningJa: '',
    definitions: definitionsAligned,
    definitionsJa,
    example: w.examples[0] ?? '',
    exampleJa: back?.example ?? '',
    phrases: phrasesEn.map((en, i) => ({ en, ja: phraseJaFor(w.id, i) })),
    synonyms,
    synonymsJa: padJaList((back?.synonyms ?? []).slice(0, synonyms.length), synonyms.length),
    antonyms: [...antEn],
    antonymsJa: padJaList(antJaSrc, antEn.length),
